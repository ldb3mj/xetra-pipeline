...
class MetaProcess():
    ...
    def update_meta_file(extract_date_list: list, meta_key: str, s3_bucket_meta: S3BucketConnector):
        ...
        :param extract_date_list: a list of the dates that are extracted from the source
    ...
    def return_date_list(first_date: str, meta_key: str, s3_bucket_meta: S3BucketConnector):
        """
        Creating a list of dates based on the in first_date and the already
        ...
        try:
            # If meta file exists create return_date)list using the content of the meta file
            ...
            if dates_missing:
                # Determing the earliest date that shoud be extracted
