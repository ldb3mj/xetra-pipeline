...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_list_files_in_prefix_ok(self) -> None:
        """
        Tests the list_files_in_prefix method for getting 2 file
        keys as list on the mock s3 bucket
        """
        # Expected results
        prefix_exp = 'prefix/'
    ...
    def test_list_files_in_prefix_wrong_prefix(self):
        """
        Tests the list_fiels_in_prefix method in case of
    ...
    def test_write_df_to_s3_csv(self):
        """
        Tests the write_df_to_s3 method when
        writing csv is successful
        """
        # Expected Result
        return_exp = True
    ...
    def test_write_df_to_s3_wrong_format(self):
        """
        Tests the write_df_to_s3 method when
        a non-supported format is given as argument
        """
        # Expected Results
        df_exp = pd.DataFrame([['A', 'B'], ['C', 'D']], columns = ['col1', 'col2'])
        key_exp = 'test.parquet'
