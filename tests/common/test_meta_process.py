...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def test_return_date_list_no_meta_file(self):
        """
        Tests the return_date_list method when
        a meta file doe not exist
        """
        # Expected results
        date_list_exp = [
    ...
    def test_return_date_list_empty_list(self):
        """
        Tests the return_date_list method when
        there are no dates to be returned
        """
        # Expected results
