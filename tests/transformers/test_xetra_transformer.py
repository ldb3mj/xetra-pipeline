...
class TestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # Creating the source and target bucket instances on mock s3
        self._s3.create_bucket(Bucket=self.s3_bucket_name_src)
        self._s3.create_bucket(Bucket=self.s3_bucket_name_trg)
        self.src_bucket = self._s3.Bucket(self.s3_bucket_name_src)
        self.trg_bucket = self._s3.Bucket(self.s3_bucket_name_trg)
        # Creating S3BucketConnector test instances
        ...
        # Creating source and target config
        conf_dict_src = {
        ...
        'trg_col_date': 'date',
        'trg_col_isin': 'isin',
        'trg_col_op_price': 'opening_price_euro',
        'trg_col_clos_price': 'closing_price_euro',
        'trg_col_min_price': 'minimum_price_euro',
        'trg_col_max_price': 'maximum_price_euro',
        ...
        # Creating source files on mock s3
        ...
        data = [['AT0000A0E9W5', 'SANT', '2021-04-15', '12:00', 20.19, 18.45, 18.20, 20.33, 877],
                ...
                ['AT0000A0E9W5', 'SANT', '2021-04-17', '14:00', 18.27, 18.89, 18.27, 21.34, 455],
        ...
        '2021-04-15/2021-04-15_BINS_XETRA12.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[1:1],
        '2021-04-16/2021-04-16_BINS_XETRA15.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[2:2],
        '2021-04-17/2021-04-17_BINS_XETRA13.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[3:3],
        '2021-04-17/2021-04-17_BINS_XETRA14.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[4:4],
        '2021-04-18/2021-04-18_BINS_XETRA07.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[5:5],
        '2021-04-18/2021-04-18_BINS_XETRA08.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[6:6],
        '2021-04-19/2021-04-19_BINS_XETRA07.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[7:7],
        '2021-04-19/2021-04-19_BINS_XETRA08.csv','csv')
        self.s3_bucket_src.write_df_to_s3(self.df_src.loc[8:8],
        '2021-04-19/2021-04-19_BINS_XETRA09.csv','csv')
        columns_report = ['ISIN', 'Date', 'opening_price_euro', 'closing_price_euro',
        'minimum_price_euro', 'maximum_price_euro', 'daily_traded_volume', 'change_prev_closing_%']
        data_report = [['AT0000A0E9W5', '2021-04-17', 20.21, 18.27, 18.21,\
                         21.34, 1088, 10.62],
                       ['AT0000A0E9W5', '2021-04-18', 20.58, 19.27, 18.89,\
                         21.14, 10286, 1.83],
                       ['AT0000A0E9W5', '2021-04-19', 23.58, 24.22, 22.21,\
                        25.01, 3586, 14.58]]
    ...
    def test_extract_no_files(self):
        ...
        return_value=[extract_date, extract_date_list]):
            xetra_etl1 = XetraETL(self.s3_bucket_src, self.s3_bucket_trg,
    ...
    def test_transform_report1_ok(self):
        """
        Test the transform_report1 with a valid DataFrame
        as input
        """
        # Expected results
        log1_exp = 'Applying transformations to Xetra source data for report 1 started...'
        log2_exp = 'Applying transformations to Xetra source data is finished...'
    ...
    def test_load(self):
        ...
        self.assertTrue(list(df_meta_result['source_date']), meta_exp)
        # Cleanup after test
